...
const Contact = () => {
  return (
    <section id="contact" className="container m-auto mt-16">
      ...
      <div className="w-[90%] sm:w-[100%] mx-auto mt-5 flex items-center justify-center sm:flex-col">
        <div className="w-[70%] flex-1 flex items-center justify-center sm:flex-col sm:w-full">
          ...
          <div className="flex p-5 items-center justify-center ">
            <button
              aria-label="arrow"
              data-aos="zoom-in"
              className="text-secondary font-extrabold text-3xl p-2 rounded-lg shadow-[0_0_10px_1px_rgba(0,0,0,0.1)] dark:shadow-[0_0_10px_1px_rgba(255,255,255,0.1)] "
            >
